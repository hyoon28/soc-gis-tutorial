...
By joining attributes with spatial boundaries, now we can map demographic patterns. When it comes to mapping, it is important to consider what type of variable you intend to display. We will learn about two different types of maps: **Choropleth map** for quantitative variables and **Typology map** for qualitative variables.
