...
```
 ...
 - Name two or more neighborhoods that are gentrifying neighborhoods.
 - Name two or more neighborhoods that are not gentrifying.
 - Is there a relationship between gentrification and racial diversity in San Francisco?
