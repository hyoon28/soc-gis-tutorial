...
sfdem <- read.csv("tutorial/data/sfnh_dem.csv")
...
st_write(sf_joined, "tutorial/data/sfnh_dem_joined.geojson", driver = "GeoJSON")
```

**THINK AND SHARE**

Below, you see two maps, each representing Chicago ans Seattle.
![Gentrification Stage Scores in Chicago and Seattle. Source: Hwang, Jackelyn. 2015.doi: 10.1177/0002716215579823](/Users/hesuyoon/Documents/ENSAE-CREST/2024/2 Fall/Teaching/soc-gis-tutorial/images/figure1.png)
